...
public class App 
{
    ...
    public static void main( String[] args ) throws SQLException, FileNotFoundException, UnsupportedEncodingException
    {
        ...
        //drunkFeatures = new HashMap<String, HashMap<String,Integer>>();
        soberFeatures = new HashMap<String, HashMap<String,Integer>>();
        ...
        while(ds1Rs.next()){
            ...
            HashMap <String,Integer> parsedFeatures = parseTweetFeatures(tweetStr);
                
            //drunkFeatures.put(tweetId, parsedFeatures);
            soberFeatures.put(tweetId, parsedFeatures);
        ...
        //printHashMaps("ds1DrunkFeatures");
        printHashMaps("ds2DrunkFeatures");
